...
const deployment_entity_1 = require("./entities/deployment.entity");
let DeploymentsService = class DeploymentsService {
    deploymentRepository;
    constructor(deploymentRepository) {
        this.deploymentRepository = deploymentRepository;
    }
    async create(createDeploymentDto, projectId) {
...
exports.DeploymentsService = DeploymentsService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(deployment_entity_1.Deployment)),
